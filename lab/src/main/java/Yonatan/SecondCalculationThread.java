...
/**
 * Created by צח on 25/10/2016.
 */
public class SecondCalculationThread extends Thread {
    public static final String DUM_SOUND = "src/main/resources/audio/hiambtom.wav";
    ...
    public SecondCalculationThread(ArrayList<collectData> movement, ArrayList<collectData> reference, double thres){
        MovementArray = movement;
        ReferenceArray = reference;
        Threshold = thres;
    }

    public SecondCalculationThread(ArrayList<collectData> movement, ArrayList<collectData> reference){
        MovementArray = movement;
        ReferenceArray = reference;
    }
