...
/**
 * Created by צח on 28/10/2016.
 */
public class ThirdCalculationThread extends Thread {
    public static final String DUM_SOUND = "src/main/resources/audio/horn.wav";
    ...
    public ThirdCalculationThread(ArrayList<collectData> movement, ArrayList<collectData> reference, double thres){
        MovementArray = movement;
        ReferenceArray = reference;
        Threshold = thres;
    }

    public ThirdCalculationThread(ArrayList<collectData> movement, ArrayList<collectData> reference){
        MovementArray = movement;
        ReferenceArray = reference;
    }
